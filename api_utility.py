...
async def api_func(x:str,request:Request):
    ...
    "updated_at":["timestamptz",["atom","users","post","comment","report","message","helpdesk"]],
    "updated_by_id":["bigint",["atom","users","post","comment","report","message","helpdesk"]],
    ...
    "is_active":["int",["atom","users","post","comment"]],
    "is_verified":["int",["atom","users","post","comment"]],
    "is_admin":["int",["atom","users","post"]],
    "is_deleted":["int",[]],
    "type":["text",["atom","users","post","helpdesk"]],
    "title":["text",["atom","users","post"]],
    "description":["text",["atom","users","post","comment","report","rating","block","message","helpdesk"]],
    ...
    "email":["text",["users","post","otp","helpdesk"]],
    "mobile":["text",["users","post","otp","helpdesk"]],
    "whatsapp":["text",["users","post"]],
