...
#create_post={"table":"post","type":"xxx","description":"xxx"}
#create_report={"table":"action","type":"report","parent_table":"post","parent_id":1,"description":"xxx"}
#create_message={"table":"activity","type":"message","parent_table":"users","parent_id":2,"description":"xxx"}
#create_like={"table":"action","type":"like","parent_table":"post","parent_id":4}
#create_comment={"table":"activity","type":"comment","parent_table":"post","parent_id":4,"description":"xxx"}
...
async def function_read(request:Request):
   #body={"table":"post", "id":1,"id_operator":">","page":1,"limit":1}
   #prework
   database=request.state.postgres_object.fetch_all
   body=await request.json()
   #token check
...
async def function_my(request:Request,background:BackgroundTasks):
   ...
   if body["mode"]=="message_received":
      ...
      values={"parent_id":user["id"],"limit":body["limit"],"offset":(body["page"]-1)*body["limit"]}
