...
"updated_at":["timestamptz",["atom","box","users","post","report","comment","message","helpdesk","workseeker"]],
"updated_by_id":["bigint",["atom","box","users","post","report","comment","message","helpdesk","workseeker"]],
