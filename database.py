...
config_column={
"created_at":[config_table,"timestamptz"],
"created_by_id":[config_table,"bigint"],
"updated_at":[["atom","users","post","comment","report","message","helpdesk","workseeker"],"timestamptz"],
"updated_by_id":[["atom","users","post","comment","report","message","helpdesk","workseeker"],"bigint"],
"is_active":[["atom","users","post","comment","workseeker"],"int"],
"is_verified":[["atom","users","post","comment","workseeker"],"int"],
"parent_table":[["likes","comment","bookmark","report","rating","block"],"text"],
"parent_id":[["likes","comment","bookmark","report","rating","block"],"bigint"],
"received_by_id":[["message"],"bigint"],
"last_active_at":[["users"],"timestamptz"],
"firebase_id":[["users"],"text"],
"otp":[["otp"],"int"],
"metadata":[["post"],"jsonb"],
